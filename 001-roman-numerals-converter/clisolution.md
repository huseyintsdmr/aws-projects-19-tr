...
aws ec2 create-security-group \
    --group-name okt_aws19_roman_numbers_converter_sec_grp \
    --description "This Sec Group is to allow ssh and http from anywhere"
```

- We can check the security Group with these commands
```bash
aws ec2 describe-security-groups --group-names okt_aws19_roman_numbers_converter_sec_grp
```
...
yum install git -y
cd /home/ec2-user
wget -P templates https://raw.githubusercontent.com/huseyintsdmr/aws-projects-19-tr/refs/heads/main/001-roman-numerals-converter/templates/index.html
wget -P templates https://raw.githubusercontent.com/huseyintsdmr/aws-projects-19-tr/refs/heads/main/001-roman-numerals-converter/templates/result.html
wget https://raw.githubusercontent.com/huseyintsdmr/aws-projects-19-tr/refs/heads/main/001-roman-numerals-converter/roman-numerals-converter-app.py
python3 roman-numerals-converter-app.py
```
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name firstkey --security-groups okt_aws19_roman_numbers_converter_sec_grp --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=okt_roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
...
aws ec2 run-instances \
    ...
    --key-name firskey \
    --security-groups okt_aws19_roman_numbers_converter_sec_grp \
...
```bash
aws ec2 delete-security-group --group-name okt_aws19_roman_numbers_converter_sec_grp
```
